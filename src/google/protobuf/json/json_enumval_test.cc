...
TEST(JsonEnumvalueOptionsTest, GauntletSerialization) {
  Knight msg;
...
TEST(JsonEnumvalueOptionsTest, CaseInsensitiveGauntletParsing) {
...
TEST(JsonEnumvalueOptionsTest, DoubleQuoteEnumSerialization) {
  Knight msg;
