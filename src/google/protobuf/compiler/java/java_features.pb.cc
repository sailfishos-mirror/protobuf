...
constexpr auto JavaFeatures_NestInFileClassFeature::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
...
constexpr auto JavaFeatures::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
