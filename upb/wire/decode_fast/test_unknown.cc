...
std::ostream& operator<<(std::ostream& os,
                         const UnknownFieldTestCase& test_case) {
  return os << test_case.name << "_Field" << test_case.field_number;
}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        UnknownFieldTestCase{100, wire_types::Fixed64{0x1234567890ABCDEF},
                             "Fixed64"},
        // UnknownFieldTestCase{2048, wire_types::Delimited{"Hello World"},
        //  "Delimited"},
        // UnknownFieldTestCase{
        // 300000,
        // wire_types::Group{{1, wire_types::Varint{456}},
        // {2, wire_types::Delimited{"Nested"}}},
        // "Group"},
